...
Write-Host -foregroundcolor Yellow "-Note that options 2 & 3 require admin permissions-"
write-host " "
  ...
  while ( $userMenuChoice -lt 1 -or $userMenuChoice -gt 4) {
    ...
    Write-Host "2. Clear CCM Cache"   
    write-host "3. Clear Temp Files"
    ...
    switch ($userMenuChoice) {
      ...
      3{#-option 3-----------------"C:\Windows\Temp\*" delete-----"C:\Users\421067\AppData\Local\Temp\*" Delete--------
